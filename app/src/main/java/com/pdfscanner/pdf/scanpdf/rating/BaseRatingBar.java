package com.pdfscanner.pdf.scanpdf.rating;
...
public class BaseRatingBar extends LinearLayout implements SimpleRatingBar {
    ...
    private void verifyParamsValue() {
        ...
        if (mEmptyDrawable == null) {
            mEmptyDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_unfill_star);
        }

        if (mFilledDrawable == null) {
            mFilledDrawable = ContextCompat.getDrawable(getContext(), R.drawable.ic_fill_star);
        }
