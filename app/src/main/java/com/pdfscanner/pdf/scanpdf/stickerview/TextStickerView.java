...
public class TextStickerView extends FrameLayout {
    ...
    public TextStickerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.TextStickerView);
        showIcons = a.getBoolean(R.styleable.TextStickerView_showIcons, false);
        showBorder = a.getBoolean(R.styleable.TextStickerView_showBorder, false);
        bringToFrontCurrentSticker =
                a.getBoolean(R.styleable.TextStickerView_bringToFrontCurrentSticker, false);
        //    if (s != null) {
